...
class CarefulPlayer(BasePokerPlayer):
    ...
    def declare_action(self, valid_actions, hole_card, round_state, bot_state=None):
        ...
        if self.nb_player < 2:
            ...
            if self.stack_to_call < my_current_stack * 0.5:
                if win_rate >= 0.9:
                    try:
        ...
        # decision made, sum required to call should be accumulated from zero again
        self.stack_to_call = 0
    ...
    def receive_game_update_message(self, action, round_state):
        self.stack_to_call += action['amount']
        self.update_round_info(round_state)
